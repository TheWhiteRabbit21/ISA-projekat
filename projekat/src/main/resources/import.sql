...
insert into users (user_type, username, password, name, surname, gender, jmbg, address_id, phone_number, points, user_catagory) values (1,'marko@gmail.com','123', 'Marko', 'Markovic', 1, 123123123, 1, '18921892', 5.00, 1);
insert into users (user_type, username, password, name, surname, gender, jmbg, address_id, phone_number, points, user_catagory) values (1,'ana@gmail.com','321', 'Petar', 'Trs', 1, 12, 2, '2313211', 3.00, 2);
insert into users (user_type, username, password, name, surname, gender, jmbg, address_id, phone_number) values (1,'boris@gmail.com','123', 'Md', 'Dh', 1, 121123123, 3, '18921892');

insert into users (user_type, username, password, name, surname, gender, jmbg, address_id, phone_number) values (2, 'goran@gmail.com','111', 'Mil', 'Mar', 0, 321124412, 4, '746352332');
insert into users (user_type, username, password, name, surname, gender, jmbg, address_id, phone_number) values (2, 'sasa@gmail.com','333', 'To', 'And', 1, 412412123, 5, '574456443');
